         ...
         for (i = 0, len = layer2_graphics.length; i < len; i++) {
            ...
            */
            ...
            if (timeExtent && construction_phase == 'construction_upcoming'){
                ...
                layer2_graphics[i].attributes.AWMP_Type = 'Under Construction';
            } else if (timeExtent && construction_phase == 'construction_finished'){
                layer2_graphics[i].setSymbol(new SimpleFillSymbol().setColor(new Color([0,128,0,1])));
                layer2_graphics[i].attributes.AWMP_Type = 'Construction Finished';
            } else {
                layer2_graphics[i].setSymbol(new SimpleFillSymbol().setColor(new Color([0,112,255,1])));
                layer2_graphics[i].attributes.AWMP_Type = 'No Construction Scheduled';
            }
         }
